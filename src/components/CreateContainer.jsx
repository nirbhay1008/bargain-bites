              ...
              {!imageAsset ? (
                ...
                <>
                  <div className="relative h-full">
                    ...
                    <button
                      type="button"
                      className="absolute bottom-3 right-3 p-3 rounded-full bg-red-400 text-xl cursor-pointer outline-none hover:shadow-md duration-500 transition-all ease-in-out"
                      onClick={deleteImage}
                    >
